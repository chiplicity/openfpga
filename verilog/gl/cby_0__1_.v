...
module cby_0__1_(ccff_head, ccff_tail, left_grid_pin_0_, prog_clk, VPWR, VGND, chany_bottom_in, chany_bottom_out, chany_top_in, chany_top_out);
  input VGND;
  input VPWR;
  wire _00_;
  input ccff_head;
  ...
  sky130_fd_sc_hd__decap_6 FILLER_3_32 (
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR)
