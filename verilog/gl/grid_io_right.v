...
module grid_io_right(ccff_head, ccff_tail, gfpga_pad_GPIO_A, gfpga_pad_GPIO_IE, gfpga_pad_GPIO_OE, gfpga_pad_GPIO_Y, left_width_0_height_0__pin_0_, left_width_0_height_0__pin_1_lower, left_width_0_height_0__pin_1_upper, prog_clk, vpwr, vgnd);
  input ccff_head;
  output ccff_tail;
  ...
  scs8hd_decap_12 FILLER_27_11 (
    .vgnd(vgnd),
    .vpwr(vpwr)
  );
  scs8hd_decap_4 FILLER_27_110 (
    .vgnd(vgnd),
    .vpwr(vpwr)
  );
  scs8hd_fill_1 FILLER_27_114 (
    .vgnd(vgnd),
    .vpwr(vpwr)
  );
