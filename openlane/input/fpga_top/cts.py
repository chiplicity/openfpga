...
clb = "grid_clb.v"
clb_inputs = []
clb_outputs = ["prog_clk__FEEDTHRU_1",  "prog_clk__FEEDTHRU_2", "prog_clk__FEEDTHRU_3", "prog_clk__FEEDTHRU_4"]
clb_buffers = [
...
def buf_prog_clk(buffers, outputs, level=2):
    ...
    elif len(buffers) == 3 and level == 1:
        in_nets =  [clk_net, "__prog_clk_buf_out__", outputs[-1]]
        out_nets = ["__prog_clk_buf_out__", outputs[-1], outputs[0]]
